...
- `-DMOMEMTA_INCLURE_DIR=(path)`: Path to your installation of MoMEMta. Use this if your version of MoMEMta was installed locally and not in your system directories
